                ...
                <div class="accordion" id="faqAccordion">
                        ...
                        <div class="card-header" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                    ...
                                    Apa tujuan dari tes diagnosis ini?
                                </button>
                            </h2>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                    ...
                                    Bagaimana cara mengikuti tes diagnosis ini?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                            1. Jawab pertanyaan yang diberikan terkait gejala yang Anda alami.<br>
                            2. Pastikan untuk memberikan informasi yang sesuai dengan kondisi Anda saat ini. <br>
                            3. Setelah selesai, sistem akan memberikan hasil diagnosis berdasarkan gejala dan tingkat kepastiannya.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed text-left" type="button" data-toggle="collapse"
                                    data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="text-align: left; width: 100%;">
                                    Jenis penyakit autoimun apa saja yang dapat didiagnosis oleh sistem ini?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                <p class="mb-3">Sistem ini dapat mendiagnosis berbagai jenis penyakit autoimun berdasarkan gejala yang Anda alami. Berikut adalah daftar penyakit autoimun yang dapat didiagnosis:</p>
                                <ol>
                                    @forelse($penyakit as $item)
                                        <li class="mb-2">{{ $item->penyakit }}</li>
                                    @empty
                                        <li class="text-muted">Tidak ada data penyakit yang tersedia.</li>
                                    @endforelse
                                </ol>
                            </div>
                        </div>
												...
												<div class='gform_page_footer top_label'>
													<a href="/form-diagnosis" class='gform_next_button button'>Next</a>
